...
function DashCoins() {
  ...
  return (
    <div className="p-6 flex justify-center shadow-md rounded-xl border border-gray-200 w-full overflow-x-auto">
      <div className="w-full sm:max-w-5xl">
              ...
              {currentCoins.map((coin) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td
                      className={`px-3 py-2 whitespace-nowrap font-semibold flex items-center gap-1`}
                    >
        ...
        {/* Pagination */}
        <div className="mt-6 flex justify-center items-center gap-2 flex-wrap text-sm text-gray-900">
